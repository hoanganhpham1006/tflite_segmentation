...
//            Classifier.Recognition mappedRecognitions = new Classifier.Recognition();
            for (int i=0; i < results.length; i++) {
              for (int j=0; j < results.length; j++) {
                if (results[i][j] == 0) {
                  ...
                  a[0] = i;
                  a[1] = j;
                  cropToFrameTransform.mapPoints(a);
                  mappedRecognitions.add(new Classifier.Recognition(new PointF(a[0], a[1])));
                }
              }
            }
